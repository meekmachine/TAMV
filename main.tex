...
\begin{itemize}
  ...
  \item In Exp 1, the target label is Brown genre, and the primary model uses TAMV distributions as document-level predictors. We report majority-class and BoW lexical baselines alongside TAMV-based classification, using accuracy, macro-F1, and confusion matrices. This setup tests whether grammatical style features provide measurable register signal beyond trivial priors and in relation to lexical baselines.
