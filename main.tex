...
\begin{itemize}
  ...
  \item Following a Reichenbach-style interpretation, tense can be modeled through relations among speech time (S), event time (E), and reference time (R), which helps explain why superficially similar verb forms can encode different temporal structures. \citep{Derczynski2012AnStructure}
