...
\begin{itemize}
  ...
  \item We additionally use Longman Grammar for initial linguistic validation of extracted TAMV patterns (not as a prediction dataset). \citep{Biber20101999LongmanEnglish}
\end{itemize}
\end{abstract}
...
\begin{itemize}
  ...
  \item \textbf{Contributions:}
    \begin{itemize}
      ...
      \item Linguistic validation of extracted TAMV patterns against Longman Grammar expectations. \citep{Biber20101999LongmanEnglish}
    \end{itemize}
\end{itemize}
...
\begin{itemize}
  ...
  \item \textbf{TAMV intrinsic evaluation:} Gold TAMV annotation set (clauses/verbal complexes). \citep{Ramm2017AnnotatingGerman,DonickeClause-LevelGerman}
...
\begin{itemize}
  \item Evaluate extracted TAMV against gold annotations: per-dimension accuracy/F1 and joint-label accuracy; error taxonomy. \citep{Ramm2017AnnotatingGerman,DonickeClause-LevelGerman}
\end{itemize}
...
\begin{itemize}
  ...
  \item Validate learned TAMV-by-register trends against Longman Grammar expectations (validation only). \citep{Biber20101999LongmanEnglish}
\end{itemize}
...
\section{Results}
\begin{itemize}
  \item \textbf{TAMV reliability:} gold-set performance and major error sources. \citep{Ramm2017AnnotatingGerman,DonickeClause-LevelGerman}
...
\begin{itemize}
  ...
  \item Role of Longman: linguistic validation reference, not a prediction dataset. \citep{Biber20101999LongmanEnglish}
\end{itemize}
