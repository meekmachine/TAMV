...
\begin{itemize}
  ...
  \item Our toxicity benchmark uses the Conversations Gone Awry dataset; we use WikiConv for corpus reconstruction context and ConvoKit for reproducible conversation processing.
  \item Our VAD benchmark uses EmoBank for sentence-level valence/arousal/dominance supervision and the NRC VAD Lexicon for lexicon-aggregation baselines.
\end{itemize}
...
\begin{itemize}
  ...
  \item \textbf{Toxicity prediction:} Conversations Gone Awry (CGA), a Wikipedia talk-page corpus labeled for conversational derailment and personal attacks, with WikiConv as reconstruction context.
  \item \textbf{VAD prediction:} EmoBank for sentence-level valence/arousal/dominance supervision and the NRC VAD Lexicon for lexicon-driven baseline features.
\end{itemize}
...
\begin{itemize}
  \item Train a toxicity classifier using TAMV-based features on CGA; report AUC/F1 against derailment labels.
...
\begin{itemize}
  \item Predict VAD labels (continuous regression or binned classification) using EmoBank supervision and compare against NRC VAD lexicon baselines.
...
\begin{itemize}
  ...
  \item \textbf{Toxicity:} report classifier results on CGA with baseline comparisons and failure analysis by conversation stage.
  \item \textbf{VAD:} report per-dimension (V/A/D) performance with regression/classification metrics and lexicon-baseline gaps.
\end{itemize}
